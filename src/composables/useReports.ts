...
export function useReports() {
   ...
   */
  async function exportXReadingsCSV() {
    ...
    return downloadCSV(csv, `x-readings-${terminalId.value}-${toLocalDateStr()}`)
  }

  /**
   * Export Z-Readings to CSV
   */
  async function exportZReadingsCSV() {
    ...
    return downloadCSV(csv, `z-readings-${terminalId.value}-${toLocalDateStr()}`)
  }
