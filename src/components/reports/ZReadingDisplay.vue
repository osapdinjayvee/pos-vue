...
const props = defineProps<{
  reading: DisplayZReading
}>()

const formattedCounter = computed(() => formatZCounter(props.reading.zCounter))
  ...
  <div class="zreading-display">
    ...
    <div class="report-info-grid">
      ...
      <div class="info-item">
        ...
        <span class="value">{{ reading.formattedDate }}</span>
      </div>
      <div class="info-item">
      ...
      <div class="info-item">
        ...
        <span class="value">{{ reading.generatedByName || reading.generatedBy }}</span>
      </div>
      <div class="info-item">
        <span class="label">Generated At</span>
        <span class="value">{{ reading.formattedGeneratedAt }}</span>
      </div>
    </div>
    ...
    <div class="report-section">
      ...
      <div class="summary-rows">
        <div class="summary-row">
          ...
          <span class="value amount">{{ formatCurrency(reading.beginningBalance) }}</span>
        </div>
        <div class="summary-row">
    ...
    <div class="report-section">
      ...
      <div class="summary-rows">
        ...
        <div class="summary-row">
          ...
          <span class="value">{{ reading.refundCount }}</span>
        </div>
        <div class="summary-row">
          <span class="label">Refund Amount</span>
          <span class="value amount">{{ formatCurrency(reading.refundAmount) }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="report-section">
      ...
      <div class="summary-rows">
        <div class="summary-row">
          <span class="label">SC Discount Count</span>
          <span class="value">{{ reading.scDiscountCount }}</span>
        </div>
        <div class="summary-row">
          <span class="label">PWD Discount Count</span>
          <span class="value">{{ reading.pwdDiscountCount }}</span>
        </div>
      </div>
    </div>
  </div>
